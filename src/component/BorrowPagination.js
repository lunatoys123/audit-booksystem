...
const BorrowPagination = (props) => {
  ...
  const goToNextPage = () => {
    ...
    const BorrowState = props.BorrowState;

    if (page < totalPage) {
      dispatch(
        NextPage({ page, limit, ComputerNo, EmployeeName, BorrowState })
      );
    }
  };
  ...
  const goToPreviousPage = () => {
    ...
    if (page > 1) {
      dispatch(
        PreviousPage({ page, limit, ComputerNo, EmployeeName, BorrowState })
      );
    }
  };
