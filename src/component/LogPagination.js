...
const LogPagination = (props) => {
  ...
  const goToNextPage = () => {
    ...
    if (page < totalPage) {
      dispatch(NextPage({ page, limit, user, Action }));
    }
  };
  ...
  const goToPreviousPage = () => {
    ...
    if (page > 1) {
      dispatch(PreviousPage({ page, limit, user, Action }));
    }
  };
  ...
  const GoToCertainPage = (event) => {
    ...
    if (targetPage <= totalPage) {
      dispatch(fetchToCertainPage({ page: targetPage, limit, user, Action }));
    }
  };
  ...
  const goToFirstPage = () => {
    ...
    dispatch(fetchToCertainPage({ page: 1, limit, user, Action }));
  };
  ...
  const goToLastPage = () => {
    ...
    dispatch(fetchToCertainPage({ page: totalPage, limit, user, Action }));
  };
  ...
  const ChangeOffset = (event) => {
    ...
    dispatch(SearchLog({ page, limit, user, Action }));
  };
  return (
